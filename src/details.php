...
<head>
  ...
  <title>Hosting Pakketten - KrasHosting</title>
  ...
  <main>
    <section id="hosting-packages">
      ...
      <table class="packages-table">
        ...
        <tbody>
          <tr>
            <td>Hosting Beginner</td>
            <td>beginners</td>
            <td>€ 5 / mnd</td>
            <td>€ 5</td>
            <td>1 domein (incl.)</td>
            <td>1 (incl.)</td>
            <td>10 GB webspace / 20 GB mailspace</td>
            <td>2.000 postvakken</td>
            <td>1 database (SSD)</td>
          </tr>
          <tr>
            <td>Hosting Dynamisch</td>
            <td>dynamische sites</td>
            <td>€ 8 / mnd</td>
            <td>€ 0</td>
            <td>1 domein (incl.)</td>
            <td>1 (incl.)</td>
            <td>20 GB webspace / 40 GB mailspace</td>
            <td>4.000 postvakken</td>
            <td>5 databases (SSD), Python & Ruby</td>
          </tr>
          <tr>
            <td>Hosting Gevorderd</td>
            <td>uitgebreide sites</td>
            <td>€ 12 / mnd</td>
            <td>€ 5</td>
            <td>1 domein (incl.)</td>
            <td>1 (incl.)</td>
            <td>60 GB webspace / 80 GB mailspace</td>
            <td>8.000 postvakken</td>
            <td>20 databases (SSD), Python & Ruby, 10 SFTP accounts</td>
          </tr>
          <tr>
            <td>Hosting Ultimate</td>
            <td>zakelijke sites</td>
            <td>€ 20 / mnd</td>
            <td>€ 5</td>
            <td>1 domein (incl.)</td>
            <td>1 (incl.)</td>
            <td>120 GB webspace / 150 GB mailspace</td>
            <td>15.000 postvakken</td>
            <td>120 databases (SSD), Python & Ruby, 50 SFTP accounts, Cronjobs</td>
          </tr>
        </tbody>
      </table>

      <p class="custom-package">Zit er niets tussen wat u wilt? Kom dan langs voor een kop koffie om te kijken naar maatwerk.</p>
    </section>
  </main>
